        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed inset-y-0 left-0 z-50 w-[80%] max-w-sm bg-white dark:bg-[#0a0a0a] shadow-2xl border-r border-zinc-200 dark:border-zinc-800 flex flex-col md:hidden"
            >
